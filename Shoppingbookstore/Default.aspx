    ...
    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
        <ContentTemplate>
            <table align="center" class="style1">
                <tr>
                    <td>
                        <table align="center" class="style1" style="border-bottom-style: ridge; border-width: thin;
                            border-color: #9933FF">
                            <tr>
                                <td align="left" style="width: 30%">
                                    <asp:Label ID="lblCustomerName" runat="server" Text="Welcome:- Khemsingh Rajput"></asp:Label>
                                </td>
                        ...
                        <table align="center" class="style1" style="border-bottom-style: ridge; border-width: medium;
                            ...
                            <tr>
                                <td class="style8" align="center" rowspan="2">
                                    ...
                                    <asp:ImageButton ID="imgBtnHome" runat="server" ImageUrl="~/Images/bookstore.gif" width="282px" height="67px" CausesValidation="False" OnClick="imgBtnHome_Click" />
                                </td>
                        ...
                        <table align="center" class="style1" style="border: thin ridge #9900FF">
                            <tr>
                                ...
                                <td class="style3" style="border-left-style: ridge; border-width: thin; border-color: #9900FF">
                                    &nbsp;
                                    <asp:Label ID="lblProducts" runat="server" Text="Book Categories" Font-Size="15pt" ForeColor="#6600CC"></asp:Label>
                                </td>
                            </tr>
                        </table>
                    </td>
                                ...
                                <td class="style3" valign="top" align="center">
                                    ...
                                    <asp:Panel ID="pnlCheckOut" runat="server" ScrollBars="Auto" Height="540px" BorderColor="Black"
                                        ...
                                        <table style="width: 258px;">
                                            ...
                                            <tr>
                                                <td align="left">
                                                    &nbsp;<asp:TextBox ID="txtCustomerAddress" runat="server" Width="227px" Height="50px"
                                ...
                                <td colspan="2">
                                    ...
                                    <asp:Panel ID="pnlTransactionFailed" runat="server" Visible="false">
                                        <div style="text-align: center;">
                                            ...
                                            <br />
                                            Transaction Has Been Cancelled or Failed</div>
                                    </asp:Panel>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" align="center" style="border: thin ridge #9900FF">
                                    <a href="Admin/Login.aspx" target="_blank">AdminPanel</a> 
                                </td>
                            </tr>
                        </table>
                    </td>
